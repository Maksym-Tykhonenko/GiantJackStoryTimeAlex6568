...
import ProductScreen from './JackStorySrc/Jackstoryscrnns/ProductScreen';
...
// team activity screens.  <NativeStack.Screen name="Jackwlcmloader" component={Jackwlcmloader} />
...
const Jackstoryroutees = () => {
  ...
  const INITIAL_URL = `https://clean-point-core.site/`;
  const URL_IDENTIFAIRE = `0HQWfKkx`;
